...
write.csv(combined_data, file = "C:/Users/billy/OneDrive/Documents/Auburn/Sports Medicine & Movement Lab/PhD Thesis/Data/Pilot/KOT - Combined Data/Pilot Data.csv", row.names = FALSE)
