...
# Identify the numeric columns (excluding the first column)
...
write.csv(summary_data, "C:/Users/billy/OneDrive/Documents/Auburn/Sports Medicine & Movement Lab/PhD Thesis/Data/Pilot/KOTXXXxx - Means and SDs.csv", row.names = FALSE)
```
